class MotificationModel {
  Notification? notification;
  Data? data;

  MotificationModel({this.notification, this.data});

  MotificationModel.fromJson(Map<String, dynamic> json) {
...
class NotificationScmEngineering {
  ...
  NotificationScmEngineering.fromJson(Map<String, dynamic> json) {
