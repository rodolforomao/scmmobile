...
import 'package:scm_engenharia_app/data/technology_model.dart';
import 'package:scm_engenharia_app/data/tb_uf.dart';
import 'package:scm_engenharia_app/data/uf_municipality_model.dart';
...
class PhysicalDistributionQuantitativeServiceView extends StatefulWidget {
  ...
  PhysicalDistributionQuantitativeServiceView(
...
class PhysicalDistributionQuantitativeServiceState extends State<PhysicalDistributionQuantitativeServiceView> {
  ...
  Future<Null> OnSalvarConta() async {
    try {
      ...
      _DistribuicaoFisicosServicoQuantitativo.cod_ibge = _TxtControllerCod_ibge.text;
