  ...
  onIncFormulario(InputSiciFileModel? siciFileModel) async {
    try {
      if (siciFileModel != null) {
        ...
        if (Components.onIsEmpty(siciFileModel.periodoReferencia) != '') {
        ...
        txtControllerSocialReason.text = Components.onIsEmpty(siciFileModel.razaoSocial);
        //Telefone Fixo:
        txtControllerLandline.text = Components.onIsEmpty(siciFileModel.telefoneFixo);
        //CNPJ:
        txtControllerCnpj.text = CNPJValidator.format(siciFileModel.cnpj!);
        //TELEFONE CELULAR:
        txtControllerTelefoneMovel.text = Components.onIsEmpty(siciFileModel.telefoneMovel);
        // Receita Bruta
        txtControllerGrossRevenue.text = Components.onIsEmpty(siciFileModel.receitaBruta);
        // Valor Simples
        txtControllerSimpleValue.text = Components.onIsEmpty(siciFileModel.simples!);
        // Aliquota Simples %
        txtControllerSimpleAliquot.text = Components.onIsEmpty(siciFileModel.simplesPorc!);
        // Valor ICMS
        txtControllerICMSvalue.text = Components.onIsEmpty(siciFileModel.icms);
        //ICMS (%)
        txtControllerIcmsPorc.text = Components.onIsEmpty(siciFileModel.icmsPorc);
        // Valor PIS
        txtControllerPis.text = Components.onIsEmpty(siciFileModel.pis);
        //PIS (%)
        txtControllerPisPorc.text = Components.onIsEmpty(siciFileModel.pisPorc);
        //Valor COFINS
        txtControllerCofins.text = Components.onIsEmpty(siciFileModel.cofins);
        // Receita Liquida
        txtControllerNetRevenue.text = siciFileModel.receitaLiquida!;
        // Observações Gerais
        txtControllerGeneralObservations.text = Components.onIsEmpty(siciFileModel.observacoes);
