class TbDistribuicaoQuantitativoAcessosFisicosServico {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id_tecnologia'] = this.id_tecnologia;
    data['pf_0'] = this.pf_0;
    data['pf_512'] = this.pf_512;
    data['pf_2'] = this.pf_2;
    data['pf_12'] = this.pf_12;
    data['pf_34'] = this.pf_34;
    data['pj_0'] = this.pj_0;
    data['pj_512'] = this.pj_512;
    data['pj_2'] = this.pj_2;
    data['pj_12'] = this.pj_12;
    data['pj_34'] = this.pj_34;
    data['id_lancamento'] = this.id_lancamento;
    data['ultima_alteracao'] = this.ultima_alteracao;
    data['id_usuario_ultima_alteracao'] = this.id_usuario_ultima_alteracao;
